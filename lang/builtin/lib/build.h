...
// Unified function descriptor — one per module function
typedef struct
{
    ModuleType module; // which module owns this
    int type;          // the module-specific enum value (MathType, OsType, etc.)
    const char *name;  // function name e.g. "__sqrt__"
    int min_args;
    int max_args;
} ModuleFuncInfo;
